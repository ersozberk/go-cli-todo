...
1. Module initialization and package management (go mod).

2. Memory addresses (Pointers) and Struct manipulation.

3. Resource management and preventing memory leaks using the defer keyword.

4. Parsing terminal arguments via the flag package.
